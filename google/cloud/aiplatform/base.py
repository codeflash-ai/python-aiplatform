...
class VertexAiResourceNoun(metaclass=abc.ABCMeta):
    ...
    def _parse_resource_name(cls, resource_name: str) -> Dict[str, str]:
        ...
        """
        # Use cached method lookup for speedup when called repeatedly
        method = _get_parse_resource_name_method_for_cls(cls)
...
def _get_parse_resource_name_method_for_cls(cls):
    return getattr(cls.client_class.get_gapic_client_class(), cls._parse_resource_name_method)
